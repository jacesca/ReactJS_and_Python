...
export const orderCreateReducer = (state = {}, action) => {
  switch(action.type){
    ...
    case ORDER_CREATE_RESET: return { order: {} }
...
export const orderDetailsReducer = (state = { loading:true, orderItems:[], shippingAddress:{} }, action) => {
  switch(action.type){
    ...
    case ORDER_DETAILS_SUCCESS: return { loading:false, success:true, order: action.payload }
...
// export const orderCalulationsReducer = (state = { calculatedAmounts: {} }, action) => {
//   switch(action.type){
//     case ORDER_CALCULATIONS_REQUEST: return { ...state, loading:true }
//     case ORDER_CALCULATIONS_SUCCESS: return { loading:false, calculatedAmounts: action.payload }
//     case ORDER_CALCULATIONS_FAIL: return { loading:false, error: action.payload }
//     case ORDER_CALCULATIONS_RESET: return { calculatedAmounts: {} }
//     default: return state
//   }
// }
